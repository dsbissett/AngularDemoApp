  ...
  this.$get = ['$rootScope', '$window', '$document', '$parse', function($rootScope, $window, $document, $parse) {
    ...
    var addToLocalStorage = function (key, value) {
      ...
      if (angular.isUndefined(value)) {
        value = null;
      } else if (angular.isArray(value) || angular.isObject(value) || angular.isNumber(value || value)) {
    ...
    var addToCookies = function (key, value) {
      ...
      if (angular.isUndefined(value)) {
        return false;
      } else if(angular.isArray(value) || angular.isArray(value)) {
        value = toJson(value);
      }
    ...
    var bindToScope = function(scope, scopeKey, def, lsKey) {
      ...
      if (value === null && isDefined(def)) {
        value = def;
      } else if (angular.isArray(value) && angular.isArray(def)) {
